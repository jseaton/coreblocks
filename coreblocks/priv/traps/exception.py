...
class ExceptionInformationRegister(Elaboratable):
    ...
    def __init__(self, gen_params: GenParams, rob_get_indices: Method, fetch_stall_exception: Method, fetch_stall_debug: Method):
    ...
    def elaborate(self, platform):
        ...
        def _(cause, rob_id, pc, mtval):
            ...
            with m.If(self.debug_mode | (cause == ExceptionCause._COREBLOCKS_DEBUG_INTERRUPT)):
        ...
        def _():
            return {"rob_id": self.rob_id, "cause": self.cause, "pc": self.pc, "mtval": self.mtval, "valid": self.valid, "debug_mode": self.debug_mode}
